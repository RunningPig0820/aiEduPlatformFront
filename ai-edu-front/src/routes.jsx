...
const teacherMenu = [
  ...
  {
    path: ROUTES.TEACHER_AI_PREPARE,
    label: 'AI备课',
    status: 'pending',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const adminMenu = [
  ...
  {
    path: ROUTES.ADMIN_KNOWLEDGE_GRAPH,
    label: '知识图谱',
    status: 'active',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
